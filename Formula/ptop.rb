class Ptop < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/freeeve/ptop/releases/download/v0.1.7/ptop-macos-aarch64.tar.gz"
      sha256 "4ca3d718969b6b6505cd8399bb1830d1c5f044722af2c5c46a449aee0cde997a"
    end
    on_intel do
